      ...
      <div {...stylex.props(s.container)}>
        <div {...stylex.props(s.left)}>
          ...
          <div {...stylex.props(s.description)}>
            ...
            <p>
              We offer system design and engineering services, customizing solar
              solutions to meet the specific energy needs and requirements of
              our clients.
            </p>
          </div>
        </div>
        ...
        <div {...stylex.props(s.center)}>
          ...
          <div {...stylex.props(s.description)}>
            ...
            <p>
              We provide professional installation services for solar panels on
        ...
        <div {...stylex.props(s.right)}>
          ...
          <div {...stylex.props(s.description)}>
            ...
            <p>
              Offering maintenance and monitoring services to ensure the optimal
              performance and longevity of solar systems.
            </p>
          </div>
        </div>
      </div>
